...
public partial class frmFCPlannerTracker : System.Web.UI.Page
{
    ...
    protected string GeneraatePDFMain()
    {
        ...
        try
        {
            ...
            //    string aaa = Server.MapPath(Server.MapPath(Comman.GetImagePath("TravelvouchersPath") + filename;
            //    Response.TransmitFile(Server.MapPath(Server.MapPath(Comman.GetImagePath("TravelvouchersPath") + filename);
