<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ForcePassword.aspx.cs" Inherits="ForcePassword" %>
                ...
                <div class="panel panel-default" style="margin-top:11px">
                    ...
                    <div class="panel-body" style="min-height: 240px;">
                        ...
                        <p class="chp-text-color">
                         ...
                         <p class="chp-text-color">
                           <asp:TextBox ID="txtText" runat="server" CssClass="form-control text-padd"></asp:TextBox>
                            <asp:TextBox ID="txtUniqueChildCode" runat="server"  CssClass="form-control text-padd"></asp:TextBox>
                            <br />

                            <asp:Button ID="btncheckEncryption"
                                runat="server"
                                Text="Encrypt Text"
                                CssClass="btn btn-primary"
                                OnClick="btncheckEncryption_Click" />

                            <br /><br />

                            <asp:Label ID="encryptedstring"
                                runat="server"
                                Font-Bold="true"
